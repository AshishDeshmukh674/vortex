...
// Updated JSON data for Dr. DY Patil Institute of Technology, Pune
const clinicData = {
  doctors: [
    {
      name: "Dr. Shreepad Bhat",
      clinics: [
        {
          header: "Dr. DY Patil Institute of Technology",
          timings: ["9:00 AM - 5:00 PM"],
          location: "Akurdi, Pune, Maharashtra, 411044",
          lat: 18.6191,
          lng: 73.8142,
        },
      ],
...
const MapComponent = () => {
  ...
  return (
    <MapContainer
      center={[18.644870, 73.761960]} // Dr. DY Patil Institute location
      zoom={13}
      style={{ height: "600px", width: "100%" }}
    >
      <TileLayer
